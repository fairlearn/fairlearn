...
def test_threshold_optimizer_multiple_sensitive_features():
    ...
    assert (
        ...
        == metricframe_multi.by_group.loc[(a1, a3)] # noqa
    ).all()
    assert (
        metricframe_combined.by_group.loc[a2 + a3]
        == metricframe_multi.by_group.loc[(a2, a3)] # noqa
    ).all()
    assert (
        metricframe_combined.by_group.loc[a1 + a4]
        == metricframe_multi.by_group.loc[(a1, a4)] # noqa
    ).all()
    assert (
        metricframe_combined.by_group.loc[a2 + a4]
        == metricframe_multi.by_group.loc[(a2, a4)] # noqa
    ).all()
