...
def test_all_correct():
    ...
    result = extra_metrics.balanced_root_mean_squared_error(y_true, y_pred)
...
def test_weighted():
    ...
    result = extra_metrics.balanced_root_mean_squared_error(y_true, y_pred, weight)
...
def test_y_true_not_0_1(y_true):
    ...
    with pytest.raises(ValueError) as execInfo:
        _ = extra_metrics.balanced_root_mean_squared_error(y_true, y_pred)
