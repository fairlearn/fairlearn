...
def test_1m_1sf_0cf(metric_fn):
    ...
    target_diff = target.difference(method='between_pairs')
    ...
    target_ratio = target.ratio(method='between_pairs')
...
def test_2m_1sf_0cf():
    ...
    target_diffs = target.difference(method='between_pairs')
...
def test_1m_1sf_2cf(metric_fn):
    ...
    diffs = target.difference(method='between_pairs')
    ...
    ratios = target.ratio(method='between_pairs')
