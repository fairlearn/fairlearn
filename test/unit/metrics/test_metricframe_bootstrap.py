...
class TestOverallQuantiles:
    ...
    def test_1m_1_cf(self, mf_1m_1_cf):
        quantiles = [0.2, 0.5, 0.9]
        overall_quantiles = mf_1m_1_cf.overall_quantiles(quantiles)
...
class TestGroupMax:
    ...
    def test_1m_1cf(self, mf_1m_1_cf):
        quantiles = [0.2, 0.5, 0.9]

        baseline = mf_1m_1_cf.group_max()
        ci_vals = mf_1m_1_cf.group_max(quantiles=quantiles)
