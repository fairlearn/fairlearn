...
def test_1m_1sf_1cf():
    ...
    assert result['recall_score'][('f', 'a')] == exp_a_f
    assert result['recall_score'][('f', 'b')] == exp_b_f
    assert result['recall_score'][('g', 'a')] == exp_a_g
    assert result['recall_score'][('g', 'b')] == exp_b_g
...
def test_2m_2sf_2cf():
    ...
    mask_a_f = np.logical_and((g_1 == 'a'), (g_2 == 'f'))
    mask_b_g = np.logical_and((g_1 == 'b'), (g_2 == 'g'))
    mask_k_q = np.logical_and((g_3 == 'k'), (g_4 == 'q'))
    ...
    assert result['recall_score'][('f', 'q', 'a', 'k')] == recall_f_q_a_k
    assert result['precision_score'][('f', 'q', 'a', 'k')] == prec_f_q_a_k
    ...
    assert result['recall_score'][('g', 'q', 'b', 'k')] == recall_g_q_b_k
    assert result['precision_score'][('g', 'q', 'b', 'k')] == prec_g_q_b_k
