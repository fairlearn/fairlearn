...
_INVALID_DATA = "Data of '{}' can not be interpreted. Only continuous data or array with only 0s and 1s."
...
_PROGRESS_UPDATE = "|{}>{}| Epoch: {}/{}, Batch: {}{}/{}, ETA: {:.2f} sec. Loss (pred/adv): {:.2f}/{:.2f}"
