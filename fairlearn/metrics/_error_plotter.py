...
class ErrorPlotter:
    ...
    def __init__(self,
        ...
        Second level keys in `error_mapping`: "upper_bound" | "lower_bound" | "upper_error" |
                                              "lower_error" | "symmetric_error"
    ...
    def plot_with_error(self, plot_type: str, metric: str, ax=None, plot_error_labels=True,
                        text_precision_digits=4, text_fontsize=8, text_color="black",
                        text_ha="center", **kwargs):
        """
        ...
        # assert exactly one of (upper_bound, lower_bound),
        #                       (upper_error, lower_error), or (symmetric_error)
