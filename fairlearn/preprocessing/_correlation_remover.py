...
class CorrelationRemover(BaseEstimator, TransformerMixin):
    ...
    values. To describe that mathematically, let's assume in the original dataset :math:`\mathbf{X}`
    we've got a set of sensitive attributes :math:`\mathbf{S}` and a set of non-sensitive attributes
    :math:`\mathbf{Z}`.
