...
* Fixed parametrized test values in ``PrototypeRepresentationLearner`` tests so all parametrize combinations are actually executed: :pr:`1626` by :user:`BALOGUN-DAVID`.
