...
* Added support for explicitly specifying optimization objective in :class:`~fairlearn.reductions.ExponentiatedGradient`.
  Added support for cost sensitive classification in :class:`~fairlearn.reductions.ErrorRate`.
