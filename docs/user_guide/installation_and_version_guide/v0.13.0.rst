...
* Removed the keyword argument `control_features` from :func:`ErrorRate.load_data`, since it was without functionality for the method: :pr:`1502` by :user:`Stefanie Senger <StefanieSenger>`.