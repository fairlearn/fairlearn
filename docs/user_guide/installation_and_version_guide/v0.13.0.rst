...
* Removed the keyword argument `control_features` from :func:`ErrorRate.load_data`, since it was without functionality for the method: :pr:`......` by :user:`Stefanie Senger <StefanieSenger>`.
