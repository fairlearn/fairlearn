...
print(f"Discrimination in the dataset:" f" {_relabeling.discrimination_dataset(y, sensitive)}")
...
print("Discrimination of classifier on the prediction before relabeling: ", discrimination)
...
print("Discrimination of classifier on the prediction after relabeling: ", discrimination_relabel)
