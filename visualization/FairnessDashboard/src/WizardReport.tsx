                    ...
                    <div className={styles.main}>
                        <div className={styles.mainLeft}>
                            ...
                            <div className={styles.expandAttributes} onClick={this.expandAttributes}>
                                {this.state.expandAttributes && <ChevronUp /> || !this.state.expandAttributes && <ChevronDown />}
                                <Text>{this.state.expandAttributes && localization.Report.collapseSensitiveAttributes || !this.state.expandAttributes && localization.Report.expandSensitiveAttributes}</Text>
                            </div>
