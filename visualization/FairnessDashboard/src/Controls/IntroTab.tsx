        ...
        return (<Stack style={{height: "100%"}}>
            <div className={styles.firstSection}>
                <Stack wrap horizontalAlign={"start"} className={styles.firstSectionContainer}>
                    ...
                    <Text className={styles.firstSectionBody} variant={"large"} block>{localization.Intro.introBody}</Text>
                    <div className={styles.firstSectionGraphics}>
                        <svg width="358" height="156" viewBox="0 0 358 156" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M98.4189 80.4179L160 136" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M178.419 135.583L239.581 66.4167" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M336.379 15.2083L260.207 49.375" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    </div>
                </Stack>
            </div>
            <div className={styles.lowerSection}>
                <div className={styles.stepsContainer}>
                    ...
                    <div className={styles.explanatoryStep}>
                        <div>
                            <Text variant={"large"} className={styles.numericLabel}>03</Text>
