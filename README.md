...
- [Current release](https://github.com/fairlearn/fairlearn/tree/v0.4.0#current-release)
- [What we mean by _fairness_](https://github.com/fairlearn/fairlearn/tree/v0.4.0#what-we-mean-by-fairness)
- [Overview of fairlearn](https://github.com/fairlearn/fairlearn/tree/v0.4.0#overview-of-fairlearn)
- [Install fairlearn](https://github.com/fairlearn/fairlearn/tree/v0.4.0#install-fairlearn)
- [Usage](https://github.com/fairlearn/fairlearn/tree/v0.4.0#usage)
- [Contributing](https://github.com/fairlearn/fairlearn/tree/v0.4.0#contributing)
- [Maintainers](https://github.com/fairlearn/fairlearn/tree/v0.4.0#maintainers)
- [Issues](https://github.com/fairlearn/fairlearn/tree/v0.4.0#issues)

## Current release

- The current stable release is available at [fairlearn v0.4.0](https://github.com/fairlearn/fairlearn/tree/v0.4.0).

- Our current version differs substantially from version 0.2 or earlier. Users of these older versions should visit our [onboarding guide](https://github.com/fairlearn/fairlearn/tree/v0.4.0#onboarding-guide).
...
To learn more about our definitions of fairness, please visit our [terminology page](https://github.com/fairlearn/fairlearn/tree/v0.4.0/TERMINOLOGY.md#fairness-of-ai-systems).
...
> _Note_:
> DP refers to demographic parity, EO to equalized odds, and BGL to bounded group loss. For more information on these and other terms we use in this repository please refer to the [terminology page](https://github.com/fairlearn/fairlearn/tree/v0.4.0/TERMINOLOGY.md). To request additional algorithms or fairness definitions, please open a [new issue](https://github.com/fairlearn/fairlearn/issues).
...
For common usage refer to the [Jupyter notebooks](./notebooks) and our [API guide](https://github.com/fairlearn/fairlearn/tree/v0.4.0/CONTRIBUTING.md#api)

## Contributing

To contribute please check our [contributing guide](https://github.com/fairlearn/fairlearn/tree/v0.4.0/CONTRIBUTING.md).
...
For a full list of contributors refer to the [authors page](https://github.com/fairlearn/fairlearn/tree/v0.4.0/AUTHORS.md)
...
Please take a look at our guidelines for reporting [security issues](https://github.com/fairlearn/fairlearn/tree/v0.4.0/SECURITY.md).
